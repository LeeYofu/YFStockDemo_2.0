...
+ (NSURLSessionDataTask *)getWithSubUrl:(NSString *)subUrlString
    ...
    NSURLSessionDataTask *task = [self requestMethod:YFNetworkRequestTypeGET subUrlString:subUrlString parameters:parameters cachePolicy:YFNetworkRequestReloadIgnoringLocalCacheData success:sucess failure:failure];
    return task;
}
...
+ (NSURLSessionDataTask *)getWithSubUrl:(NSString *)subUrlString
    ...
    NSURLSessionDataTask *task = [self requestMethod:YFNetworkRequestTypeGET subUrlString:subUrlString parameters:parameters cachePolicy:requestCachePolicy success:sucess failure:failure];
    return task;
}
...
+ (NSURLSessionDataTask *)postWithSubUrl:(NSString *)subUrlString
    ...
    NSURLSessionDataTask *task = [self requestMethod:YFNetworkRequestTypePOST subUrlString:subUrlString parameters:parameters cachePolicy:YFNetworkRequestReloadIgnoringLocalCacheData success:sucess failure:failure];
    return task;
}
...
+ (NSURLSessionDataTask *)postWithSubUrl:(NSString *)subUrlString
    ...
    NSURLSessionDataTask *task = [self requestMethod:YFNetworkRequestTypePOST subUrlString:subUrlString parameters:parameters cachePolicy:requestCachePolicy success:sucess failure:failure];
    return task;
}
...
+ (NSURLSessionDataTask *)requestMethod:(YFNetworkRequestType)type
    ...
    NSURLSessionDataTask *task = [self requestMethod:type subUrlString:subUrlString parameters:parameters cache:cache cacheKey:cacheKey success:success failure:failure];
